...
func ConvertToCiliumSRv6EgressPolicy(obj interface{}) (interface{}, error) {
	...
	case cache.DeletedFinalStateUnknown:
		...
		if !ok {
			return obj, fmt.Errorf("cast to CiliumSRv6EgressPolicy failed")
		}
		return cache.DeletedFinalStateUnknown{
			Key: concreteObj.Key,
	...
	default:
		return obj, fmt.Errorf("incorrect obj type")
	}
}
...
// nor cache.DeletedFinalStateUnknown, the original obj is returned.
func ConvertToCiliumSRv6VRF(obj interface{}) (interface{}, error) {
	...
	case cache.DeletedFinalStateUnknown:
		...
		if !ok {
			return obj, fmt.Errorf("cast to CiliumSRv6VRF failed")
		}
		return cache.DeletedFinalStateUnknown{
			Key: concreteObj.Key,
			Obj: ciliumSRv6VRF,
