            ...
            steps {
                script {
                    ...
                    if (env.run_with_race_detection?.trim()) {
                        ...
                        env.RACE = 1
                        env.LOCKDEBUG = 1
                        env.BASE_IMAGE = "quay.io/cilium/cilium-runtime:3cd1207eb07098112e812a9ee0df91b668116d7a@sha256:83a904999a4664fa5eb747274ab1afa436113e89c52d8713f6e59a7bb43be6f2"
                    }
                }
            }
        }
