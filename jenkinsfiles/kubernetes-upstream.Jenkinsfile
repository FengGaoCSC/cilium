            ...
            steps {
                script {
                    ...
                    if (env.run_with_race_detection?.trim()) {
                        ...
                        env.RACE = 1
                        env.LOCKDEBUG = 1
                        env.BASE_IMAGE = "quay.io/cilium/cilium-runtime:4a403254fd137bd8e46d5cd60f943408ab36104c@sha256:f9bd43481d00870147f1acc9a37d78ab9756f3eeaff8a196bbf95da3b448c6d8"
                    }
                }
            }
        }
