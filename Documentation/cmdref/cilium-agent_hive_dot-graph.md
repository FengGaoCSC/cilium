...
```
      ...
      --install-egress-gateway-ha-routes                             Install egress gateway IP rules and routes in order to properly steer egress gateway traffic to the correct ENI interface
